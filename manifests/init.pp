...
class nodejs(
  ...
  $nodejs_debug_package_install_options = $nodejs::params::nodejs_debug_package_install_options,
  ...
  $nodejs_dev_package_install_options   = $nodejs::params::nodejs_dev_package_install_options,
  $nodejs_dev_package_name              = $nodejs::params::nodejs_dev_package_name,
  $nodejs_package_ensure                = $nodejs::params::nodejs_package_ensure,
  $nodejs_package_install_options       = $nodejs::params::nodejs_package_install_options,
  $nodejs_package_name                  = $nodejs::params::nodejs_package_name,
  $npm_package_ensure                   = $nodejs::params::npm_package_ensure,
  $npm_package_install_options          = $nodejs::params::npm_package_install_options,
  ...
  if $nodejs_debug_package_install_options {
    validate_array($nodejs_debug_package_install_options)
  }
  ...
  if $nodejs_dev_package_install_options {
    validate_array($nodejs_dev_package_install_options)
  }
  ...
  if $npm_package_install_options {
    validate_array($npm_package_install_options)
  }
